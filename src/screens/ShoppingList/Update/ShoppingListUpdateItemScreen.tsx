...
export const ShoppingListUpdateItemScreen = ({navigation, route}: ShoppingListNavigationProps<"UpdateItemScreen">) => {
    ...
    return (
        <Screen title={"Update shopping item"} headerColor={theme.colors.headers.shoppingList}>
            <ScrollView>
