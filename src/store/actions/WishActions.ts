...
export type WishAction =
    ...
    Action<"buy_wish"> & { wish: Wish, actualValue: Money, budgetId: Id }
...
export const buyWish = (wish: Wish, actualValue: Money, budgetId: Id): WishAction => ({type: "buy_wish", wish, actualValue, budgetId})
